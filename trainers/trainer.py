...
class Trainer(BaseTrainer):
    ...
    def __init__(self, data_loader, config, backbone, full):
        ...
        self.train_dataset = data_loader.get_train_data_generator()
        self.valid_dataset = data_loader.get_valid_data_generator()
    ...
    def train(self):
        for epoch in range(self.config.trainer.num_epochs):
            ...
            for image_train, label_train in self.train_dataset:
                ...
                metric_logs = {}
                loss = self.full.train_on_batch(image_train, label_train)
